        ...
        <div className = "grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
            ...
            <div ref = {grid2Container} className = "grid-default-color grid-2">
                <div className = "flex items-center justify-center w-full h-full">
                    <p className = "flex items-center text-5xl text-gray-500">CODING IS COOL</p>
                    <Card style  = {{rotate: "75deg", top: "30%", left: "20%"}} text = "OPTIMIZED STRUCTURES" containerRef= {grid2Container}/>

                    <Card style  = {{rotate: "-30deg", top: "60%", left: "45%"}} text = "CURIOUS LEARNER" containerRef= {grid2Container}/>

                    <Card style  = {{rotate: "90deg", bottom: "30%", left: "70%"}} text = "INNOVATIVE IDEAS" containerRef= {grid2Container}/>

                    <Card style  = {{rotate: "-45deg", top: "55%", left: "0%"}} text = "DESIGN PRINCIPLES" containerRef= {grid2Container}/>

                    <Card style  = {{rotate: "20deg", top: "10%", left: "30%"}} text = "DETAIL-ORIENTED" containerRef= {grid2Container}/>

                    <Card style  = {{rotate: "30deg", top: "70%", left: "70%"}} image = "assets/logos/css3.svg" containerRef= {grid2Container} />

                    <Card style  = {{rotate: "-45deg", top: "70%", left: "25%"}} image = "assets/logos/vitejs.svg" containerRef= {grid2Container} />

                    <Card style  = {{rotate: "-45deg", top: "5%", left: "10%"}} image = "assets/logos/stripe.svg" containerRef= {grid2Container}/>
                </div>
            </div>
